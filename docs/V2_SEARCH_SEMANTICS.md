...
Frozen originally in `personalrag-v2` 0.3.0; integrated canonical implementation: **0.4.0**
...
## 10. Step 2 integration identity

The frozen semantics above are implemented in the canonical Step 1 + Step 2 tree with production persistent format `PRV2IDX1` **version 2** and search semantic id `0x0003_0001`. Format v1 is intentionally rejected because it represented the earlier ASCII-fold index semantics.
